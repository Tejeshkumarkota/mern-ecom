...
/*admin Components*/
import DashboardEcom from '../components/admin/dashboard/dashboard'
import UserList from '../components/admin/users/list-user'
import Calendar from '../components/admin/calendar/calendar'
import VendorListing from '../components/admin/vendors/vendor-list'
import CategoryListing from '../components/admin/vendors/category-list'
import RequestApprovalWrapper from '../components/admin/request-approval/request-approval-wrapper'
import ResidentsOverview from '../components/admin/customer-support/residents/residents-overview'
import VendorsOverview from '../components/admin/customer-support/vendors/vendors-overview'
import FaqsOverview from '../components/admin/customer-support/faqs/faq-overview'
// vendor food service
import DashboardWrapper from '../components/vendor-food-service/dashboard/dashboard-wrapper'
    ...
    <Fragment>
        <Routes>
			...
			<Route
						...
						element={<DashboardEcom />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/admin/vendor`}
						element={<VendorListing />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/admin/vendor/category-list`}
					...
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/admin/request-approval-list`}
						element={<RequestApprovalWrapper />}
					/>
					<Route
					...
					/> 
					<Route
						path={`${process.env.PUBLIC_URL}/admin/customer-support/residents`}
						element={<ResidentsOverview />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/admin/customer-support/vendors`}
						element={<VendorsOverview />}
					/>
					<Route
						path={`${process.env.PUBLIC_URL}/admin/customer-support/faq`}
						element={<FaqsOverview />}
					/>
					{/* vendor food service */}
					<Route
						path={`${process.env.PUBLIC_URL}/vendor-food/dashboard`}
